      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-navy-light rounded-lg border border-border p-6">
              ...
              <ul className="list-disc list-inside space-y-1 text-foreground mb-4">
                ...
                <li>
                  Any child profile names (to help us identify your account)
                </li>
              </ul>
              <p className="text-text-secondary">
                We will process your request within 7 business days and send you
        ...
        <div className="mb-8">
          ...
          <div className="bg-navy-light rounded-lg border border-border p-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-foreground">
              ...
              <li>
                <strong>Child Profiles:</strong> Names, birth dates, interests,
                preferences, physical descriptions
              </li>
              <li>
                <strong>Generated Stories:</strong> All stories created using
                our AI service
              </li>
              <li>
                <strong>User Content:</strong> Custom prompts, themes, and
                character descriptions
              </li>
              <li>
                <strong>Subscription Data:</strong> RevenueCat subscription and
                purchase history
              </li>
              <li>
                <strong>App Settings:</strong> Preferences and app configuration
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="bg-success/10 border border-success/30 rounded-lg p-6 mb-4">
            <p className="text-foreground">
              <strong className="text-success">Immediate Deletion:</strong> Most
              data is deleted immediately when you request account deletion.
            </p>
          </div>

          <div className="space-y-4 text-foreground">
            <p>
              <strong>Backup Retention:</strong> Due to our backup systems, some
              data may remain in encrypted backups for up to 30 days before
              being permanently purged.
            </p>
            <p>
              <strong>Legal Requirements:</strong> We may retain certain
              transaction records as required by law, but these will not contain
              personal information and cannot be used to identify you.
            </p>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="bg-navy-light rounded-lg border border-border p-6">
            <p className="text-foreground mb-4">
              Account deletion does not automatically cancel active
              subscriptions. To avoid future charges:
            </p>
            <ul className="list-disc list-inside space-y-2 text-foreground">
              <li>
                <strong>iOS:</strong> Cancel your subscription in the App Store
                settings
              </li>
              <li>
                <strong>Android:</strong> Cancel your subscription in Google
                Play settings
              </li>
            </ul>
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="bg-navy-light rounded-lg border border-border p-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-foreground">
              <li>
                <strong>Save Stories:</strong> Export or save any stories you
                want to keep before deleting
              </li>
              <li>
              ...
              <li>
                <strong>Contact Support:</strong> We may be able to help resolve
