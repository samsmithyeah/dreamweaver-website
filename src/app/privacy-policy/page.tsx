...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for DreamWeaver - Learn how we protect your and your children\'s privacy.',
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-text-secondary">
            Learn how DreamWeaver protects your and your children&apos;s privacy.
          </p>
        </div>

        <div className="space-y-8">
          {sections.map((section, index) => (
            <div key={index} className="bg-navy-light rounded-lg border border-border p-6">
