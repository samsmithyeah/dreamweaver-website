...
export function CoverImage({ imageUrl, title }: CoverImageProps) {
  ...
  return (
    <div className="rounded-2xl border-[3px] border-primary overflow-hidden shadow-[0_0_40px_rgba(212,175,55,0.4)] mb-6 landscape:mb-0 landscape:w-1/2 landscape:max-h-[calc(100vh-93px-2rem)] bg-cream">
      {imageUrl && (
